...
const HourlyForecast: React.FC<{ data: any[] }> = ({ data }) => {
  return (
    <div className="bg-gradient-to-r from-blue-400 to-blue-600 rounded-xl shadow-lg p-4 max-w-md w-full mx-auto">
      <h3 className="text-white text-lg font-semibold mb-3">Hourly Forecast</h3>
      <div className="flex justify-between">
        {data.map((item, index) => (
          <div
            key={index}
            className="text-center bg-white bg-opacity-20 rounded-lg p-2"
          >
